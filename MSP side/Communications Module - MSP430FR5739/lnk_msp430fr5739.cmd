...
SECTIONS
{
    ...
    TIMER2_B1    : { * ( .int42 ) } > INT42 type = VECT_INIT
    TIMER2_B0    : { * ( .int43 ) } > INT43 type = VECT_INIT
    PORT2        : { * ( .int44 ) } > INT44 type = VECT_INIT
    TIMER1_B1    : { * ( .int45 ) } > INT45 type = VECT_INIT
    TIMER1_B0    : { * ( .int46 ) } > INT46 type = VECT_INIT
    ...
    COMP_D       : { * ( .int60 ) } > INT60 type = VECT_INIT
